...
<!-- 
FulHoldShelfRequestSlipLetter.xsl
Lettre de Demande de Retrait en Rayon
A METTRE DANS L'OUVRAGE AVANT DE METTRE LE DOC 
SUR L'ETAGERE DES RESERVATIONS EN ATTENTE
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                <h1><!--@@requested_for@@ : --><xsl:value-of select="notification_data/user_for_printing/name" /></h1>
                ...
                <div class="messageArea">
                    <div class="messageBody">
                        <table cellspacing="0" cellpadding="5" border="0">
                            ...
                            <!-- nicomo : on a ensuite les infos d'exemplaire -->
                            ...
                            <xsl:if test="notification_data/request/manual_description != ''">
                                <tr>
                                    <td>
                                        <b>@@please_note@@: </b>@@manual_description_note@@ - <xsl:value-of select="notification_data/request/manual_description" /></td>
                                </tr>
                            </xsl:if>
                            <xsl:if test="notification_data/request/selected_inventory_type='ITEM'">
                                <tr>
                            ...
                            <!--
                            nicomo : le nom de l'usager est déjà présent dans l'en-tête
