		...
		<td width="50%" align="right">
			<xsl:for-each select="notification_data/organization_unit">
		        <table>
                    ...
                    <!-- We now have several addresses and can't hardcode this one. nicomo - 20200709 -->
                    <tr><td><a href="mailto:services.humatheque@campus-condorcet.fr">services.humatheque@campus-condorcet.fr</a></td></tr>
                   <!-- 
