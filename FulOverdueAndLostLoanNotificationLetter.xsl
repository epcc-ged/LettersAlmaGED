						...
						<tr>
							<td>
								<table cellpadding="5" class="listing">
									...
									<!-- nicomo 06/09/2019
									En-tête de tableau affichant "GED" (library). Supprimer
									...
									<tr>
										<th>@@lost_item@@</th>
										<!-- nicomo 06/09/2019
										suppression des colonnes toujours vides (descriptions)
										ou dont la valeur est unique (library)
										<th>@@description@@</th>
										<th>@@library@@</th>
										-->
										<th>@@loan_date@@</th>
									...
									<xsl:for-each select="item_loans/overdue_and_lost_loan_notification_display">
										<tr>
											...
											<!-- nicomo 06/09/2019 suppression de colonnes inutiles
