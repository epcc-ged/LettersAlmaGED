...
<!-- this file: LoanStatusNotice.xsl, mais cas compliqué car apparaît comme FulItemChangeDueDateLetter dans l'envoi !  -->
<!-- Historique de mise à jour Campus Condorcet
    2021-01-08 JCS : adaptation pour prise de rdv pendant le Covid
	2022-01-28 JCS : suppression de l'adaptation précédente
-->
