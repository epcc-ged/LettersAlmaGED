...
<!-- This file: FulReasourceRequestSlipLetter.xsl 
	2021-07-08 JCS : modification de l'indication de localisation dans le cas de IRHT_DOC
-->
						...
						<tr>
							...
							<td style="border:solid 2px #060">
								<h2>
									...
									<!-- On complète l'indication de localisation dans le cas de la doc associée IRHT_DOC -->
									<xsl:choose>
