		...
		<xsl:call-template name="generalStyle" />
          ...
          <div class="messageBody">
			...
			<table role='presentation'>
				<tr>
					<td>
						En raison du contexte sanitaire, la prise de rendez-vous est obligatoire. Vous pouvez sélectionner un créneau en suivant ce lien : https://evento.renater.fr/survey/acces-au-ged-hors-les-murs-pendant-le-confinement-o0zy4wzf
					</td>
				</tr>
			</table>
			<br />
